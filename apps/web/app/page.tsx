...
export const metadata = {
  ...
  description:
    "A hidden tropical sanctuary in Fort Lauderdale for peace, reconnection, and a deeper reset. Sound bath, meditation, breathwork, Yoga Nidra and more.",
};
...
const servicios = [
  {
    ...
    items: [
      ...
      "Immersive sound healing (focused on you)",
    ],
  },
  {
    ...
    items: [
      "Guided meditation to arrive",
      "Gentle breathwork",
      "Intention setting",
      "Immersive sound healing with bowls",
    ],
  },
  {
    ...
    items: [
      ...
      "Sound healing with bowls around the water",
      "Deep nervous system reset",
      "Enhanced emotional release + grounding",
    ],
  },
];
...
const testimonios = [
  { texto: "The sound healing experience was incredibly grounding and beautiful. The space itself is magical — every detail feels intentional and calming.", autor: "Adriana (wellness guest)" },
  { texto: "A hidden sanctuary in the middle of the city. Casa Selva is unlike anything else in South Florida — peaceful, soulful, and unforgettable.", autor: "Frank (retreat participant)" },
  { texto: "A hidden corner of the retreat where nature surrounds you. The peaceful outdoor setting makes Casa Selva feel like a private sanctuary.", autor: "Jennifer (private event guest)" },
];
    ...
    <main className="bg-[#f7f3ec] text-[#3a2e22]">
      <header className="fixed top-0 z-50 w-full backdrop-blur-md bg-[#3a2e22]/30">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          ...
          <Link href="/reservar" className="rounded-full border border-[#f7f3ec]/60 px-6 py-2 text-xs uppercase tracking-widest text-[#f7f3ec] transition hover:bg-[#f7f3ec] hover:text-[#3a2e22]">
            Book now
          </Link>
        </nav>
      </header>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-6 text-center text-[#f7f3ec]">
          ...
          <Link href="/reservar" className="mt-10 inline-block rounded-full bg-[#7a8b6f] px-12 py-4 text-sm uppercase tracking-widest text-white shadow-lg transition hover:bg-[#697a5f] hover:shadow-xl">
            Learn more
          </Link>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-6 py-28 text-center">
        ...
        <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-[#5c4f40]">
          The Casa Selva is a hidden tropical sanctuary in Fort Lauderdale created for those seeking peace, reconnection, and a deeper reset.
        </p>
        <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-[#5c4f40]">
          Surrounded by nature, our space blends sound bath, guided meditation, breathwork, Yoga Nidra, grounding rituals, aromatherapy, and intentional rest in an intimate luxury setting.
        </p>
      </section>
...
cat > apps/web/app/page.tsx << 'CASASELVA'
import Link from "next/link";
    ...
    <main className="bg-[#f7f3ec] text-[#3a2e22]">
      ...
      <section id="experiencia" className="bg-[#ece4d6] py-28">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mx-auto mt-12 max-w-2xl text-lg leading-relaxed text-[#5c4f40]">
            A private, immersive reset in a hidden sanctuary. Step into a deeply curated experience designed to help you disconnect from the outside world and reconnect with yourself. This private mini-retreat gently guides you through a journey of release, restoration, and inner balance.
          </p>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-3 px-6 md:grid-cols-4">
          {galeria.map((src, i) => (
            <div key={i} className="aspect-square overflow-hidden rounded-xl">
              <img src={src} alt={"The Casa Selva " + (i + 1)} className="h-full w-full object-cover transition duration-700 hover:scale-110" />
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {testimonios.map((t) => (
            <div key={t.autor} className="rounded-2xl bg-white p-8 shadow-sm">
              <p className="text-[#5c4f40]">&ldquo;{t.texto}&rdquo;</p>
      ...
      <section id="contacto" className="bg-[#3a2e22] px-6 py-28 text-center text-[#f7f3ec]">
        ...
        <div className="mx-auto mt-10 grid max-w-3xl gap-8 md:grid-cols-2">
          <div>
            ...
            <p>Saturday &amp; Sunday · 9:00 am – 12:00 noon</p>
          </div>
          <div>
        ...
        <Link href="/reservar" className="mt-12 inline-block rounded-full bg-[#7a8b6f] px-12 py-4 text-sm uppercase tracking-widest text-white transition hover:bg-[#697a5f]">
          Book your reset
        </Link>
      </section>
      ...
      <footer className="bg-[#2c231a] px-6 py-12 text-center text-sm text-[#a89b86]">
        ...
        <p className="mt-6">© {new Date().getFullYear()} The Casa Selva. All rights reserved.</p>
      </footer>
    </main>
  );
}
